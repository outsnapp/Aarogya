-- Aarogya App Database Schema for Supabase (WORKING VERSION)
-- This version DISABLES RLS for user_profiles to allow signup
...
-- DISABLE RLS for user_profiles to allow signup (can be enabled later)
